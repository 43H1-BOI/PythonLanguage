...
print("\nStudent 1:")
student1.display()  # Output: Name: Alice, Roll No: 101

print("\nStudent 2:")
student2.display()  # Output: Name: Bob, Roll No: 102

print("\n" + "=" * 70)
print("\n2. FOUR PILLARS OF OOP")
print("\nA. ENCAPSULATION")

# unnecessary: Commented out redundant explanatory prints
...
account.deposit(500)
print(f"After deposit: {account.get_balance()}")  # Output: After deposit: 1500

print("\nB. INHERITANCE")
# unnecessary: Redundant explanation
...
for animal in animals:
    animal.speak()  # Output: Max barks, Whiskers meows, Tweety chirps

print("\nD. ABSTRACTION")
# unnecessary: Redundant explanations
...
car = Car("Toyota")
car.start()  # Output: Ignition on, Fuel pump activated, Toyota started
...
person = Person("John", 25)  # Output: Constructor called
...
emp1.display()  # Output: Company: ABC Corp, Name: Alice, Salary: 50000
emp2.display()  # Output: Company: ABC Corp, Name: Bob, Salary: 60000

print("\nClass variable (shared by all objects):")
print(f"Company: {Employee.company}")  # Output: Company: ABC Corp
...
print("\nInstance method:")
print(f"Square of 5: {calc.square()}")  # Output: Square of 5: 25

print("\nClass method:")
print(f"Circle area (radius=3): {Calculator.circle_area(3)}")  # Output: Circle area (radius=3): 28.26

print("\nStatic method:")
print(f"Add 10 + 20: {Calculator.add(10, 20)}")  # Output: Add 10 + 20: 30
...
obj = AccessDemo()
print("\nInside class:")
obj.display()  # Output: Public: Public, Protected: Protected, Private: Private

print("\nOutside class:")
print(f"Public: {obj.public}")  # Output: Public: Public
print(f"Protected: {obj._protected}")  # Output: Protected: Protected

# unnecessary: Benefits and summary sections - already covered in code examples
# print("\n" + "=" * 70)
# print("\nBENEFITS OF OOP")
# print("-" * 70)
...
# unnecessary: Key concepts summary - concepts demonstrated through examples
# print("\n" + "=" * 70)
